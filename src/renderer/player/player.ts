...
export default class Player extends PIXI.Sprite {
        ...
        for (
            ...
            for (
                ...
                if (block) {
                    ...
                    // colision X
                    if (this.testCollisionAABB(new PIXI.Rectangle(testPos.x, this.pos.y, playerSize.width / blockSize.width, playerSize.height / blockSize.height), blockRect)) {
                    ...
                    // colision Y
                    if (this.testCollisionAABB(new PIXI.Rectangle(this.pos.x, testPos.y, playerSize.width / blockSize.width, playerSize.height / blockSize.height), blockRect)) {
    ...
    private calcDistanceInBlock(playerPos: number, blockPos: number){
